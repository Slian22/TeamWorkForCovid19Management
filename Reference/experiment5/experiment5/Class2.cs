...
namespace experiment5
{
    class DBUtil
    {
        ...
        {
            String connetStr = "server=LAPTOP-MT9GJTVI\\SQLEXPRESS;database=员工信息;Integrated Security=true;";//uid=sa;pwd=123456
        ...
        {
            connection();
            string sql = "select * from 职工信息表 where 操作员=@para1 and 密码=@para2";//在sql语句中定义parameter，然后再给parameter赋值
