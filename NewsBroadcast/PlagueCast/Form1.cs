...
namespace PlagueCast
{
    public partial class Form1 : Form
    {
        ...
        private void splashTimer_Tick(object sender, EventArgs e)
        {
            ...
            notificationQueue.Add(new FrmNewsDialog("提示：单击新闻列表项目打开详情","单击新闻列表中的一项可以查看标题，内容和原始链接。点击此详情即可查看当前可视化项目", "http://localhost:63342/Visualization/COVID-19-Charts-master/public/index.html?_ijt=l4stgpj16nhhlq41nrco1j65nv#tab=world-map"));
            raiseNotification();
        }
